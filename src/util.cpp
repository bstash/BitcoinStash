...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\Bitcoinstash
// Windows >= Vista: C:\Users\Username\AppData\Roaming\Bitcoinstash
// Mac: ~/Library/Application Support/Bitcoinstash
// Unix: ~/.bitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitcoinstash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitcoinstash";
#else
    // Unix
    return pathRet / ".bitcoinstash";
#endif
#endif
}
