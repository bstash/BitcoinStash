UNIX BUILD NOTES
====================
Some notes on how to build Bitcoin Stash in Unix.
...
memory available when compiling Bitcoin Stash. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Bitcoin Stash without wallet.
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://github.com/bstash/bitcoinstash
    cd bitcoinstash/
    ./autogen.sh
